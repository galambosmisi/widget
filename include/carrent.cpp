...
:Window(name, XX,YY,back_,text_,aline_,pline_,bg_)
    {
        ...
        berles_nev = new DropDownMenu(this, 10, 50, 150, 30, true, true, 5, nevek);
        berles_auto = new DropDownMenu(this, 170, 50, 150, 30, true, true, 10, autok);
        berles = new Button(this, 330, 30, 100, 30, true, "middle", "Berles", [this]()
        {
            if(berles_nev->has_item() && berles_auto->has_item())
            {
        ...
        ki_berles = new DropDownMenu(this, 440, 50, 250, 30, true, false, 14, _berles);
    }
